...
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
| 24 Pull Requests|https://24pullrequests.com/api | Project to promote open source collaboration during December | No | Yes | Yes |Software Engineering and Development
| Abstract Screenshot|https://www.abstractapi.com/website-screenshot-api | Take programmatic screenshots of web pages from any website | `apiKey` | Yes | Yes |Software Engineering and Development
| Agify.io|https://agify.io | Estimates the age from a first name | No | Yes | Yes |Software Engineering and Development
| API Grátis|https://apigratis.com.br/ | Multiples services and public APIs | No | Yes | Unknown |Software Engineering and Development
| ApicAgent|https://www.apicagent.com | Extract device details from user-agent string | No | Yes | Yes |Software Engineering and Development
| ApiFlash|https://apiflash.com/ | Chrome based screenshot API for developers | `apiKey` | Yes | Unknown |Software Engineering and Development
| apilayer userstack|https://userstack.com/ | Secure User-Agent String Lookup JSON API | `OAuth` | Yes | Unknown |Software Engineering and Development
| APIs.guru|https://apis.guru/api-doc/ | Wikipedia for Web APIs, OpenAPI/Swagger specs for public APIs | No | Yes | Unknown |Software Engineering and Development
| Azure DevOps|https://docs.microsoft.com/en-us/rest/api/azure/devops | The Azure DevOps basic components of a REST API request/response pair | `apiKey` | Yes | Unknown |Software Engineering and Development
| Base|https://www.base-api.io/ | Building quick backends | `apiKey` | Yes | Yes |Software Engineering and Development
| Beeceptor|https://beeceptor.com/ | Build a mock Rest API endpoint in seconds | No | Yes | Yes |Software Engineering and Development
| Bitbucket|https://developer.atlassian.com/bitbucket/api/2/reference/ | Bitbucket API | `OAuth` | Yes | Unknown |Software Engineering and Development
| Blague.xyz|https://blague.xyz/ | La plus grande API de Blagues FR/The biggest FR jokes API | `apiKey` | Yes | Yes |Software Engineering and Development
| Blitapp|https://blitapp.com/api/ | Schedule screenshots of web pages and sync them to your cloud | `apiKey` | Yes | Unknown |Software Engineering and Development
| Blynk-Cloud|https://blynkapi.docs.apiary.io/# | Control IoT Devices from Blynk IoT Cloud | `apiKey` | No | Unknown |Software Engineering and Development
| Bored|https://www.boredapi.com/ | Find random activities to fight boredom | No | Yes | Unknown |Software Engineering and Development
| Brainshop.ai|https://brainshop.ai/ | Make A Free A.I Brain | `apiKey` | Yes | Yes |Software Engineering and Development
| Browshot|https://browshot.com/api/documentation | Easily make screenshots of web pages in any screen size, as any device | `apiKey` | Yes | Yes |Software Engineering and Development
| CDNJS|https://api.cdnjs.com/libraries/jquery | Library info on CDNJS | No | Yes | Unknown |Software Engineering and Development
| Changelogs.md|https://changelogs.md | Structured changelog metadata from open source projects | No | Yes | Unknown |Software Engineering and Development
| Ciprand|https://github.com/polarspetroll/ciprand | Secure random string generator | No | Yes | No |Software Engineering and Development
| Cloudflare Trace|https://github.com/fawazahmed0/cloudflare-trace-api | Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More | No | Yes | Yes |Software Engineering and Development
| Codex|https://github.com/Jaagrav/CodeX | Online Compiler for Various Languages | No | Yes | Unknown |Software Engineering and Development
| Contentful Images|https://www.contentful.com/developers/docs/references/images-api/ | Used to retrieve and apply transformations to images | `apiKey` | Yes | Yes |Software Engineering and Development
| CORS Proxy|https://github.com/burhanuday/cors-proxy | Get around the dreaded CORS error by using this proxy as a middle man | No | Yes | Yes |Software Engineering and Development
| CountAPI|https://countapi.xyz | Free and simple counting service. You can use it to track page hits and specific events | No | Yes | Yes |Software Engineering and Development
| Databricks|https://docs.databricks.com/dev-tools/api/latest/index.html | Service to manage your databricks account,clusters, notebooks, jobs and workspaces | `apiKey` | Yes | Yes |Software Engineering and Development
| DigitalOcean Status|https://status.digitalocean.com/api | Status of all DigitalOcean services | No | Yes | Unknown |Software Engineering and Development
| Docker Hub|https://docs.docker.com/docker-hub/api/latest/ | Interact with Docker Hub | `apiKey` | Yes | Yes |Software Engineering and Development
| DomainDb Info|https://api.domainsdb.info/ | Domain name search to find all domains containing particular words/phrases/etc | No | Yes | Unknown |Software Engineering and Development
| ExtendsClass JSON Storage|https://extendsclass.com/json-storage.html | A simple JSON store API | No | Yes | Yes |Software Engineering and Development
| GeekFlare|https://apidocs.geekflare.com/docs/geekflare-api | Provide numerous capabilities for important testing and monitoring methods for websites | `apiKey` | Yes | Unknown |Software Engineering and Development
| Genderize.io|https://genderize.io | Estimates a gender from a first name | No | Yes | Yes |Software Engineering and Development
...
| License-API|https://github.com/cmccandless/license-api/blob/master/README.md | Unofficial REST API for choosealicense.com | No | Yes | No |Software Engineering and Development
...
| ScreenshotAPI.net|https://screenshotapi.net/ | Create pixel-perfect website screenshots | `apiKey` | Yes | Yes |Software Engineering and Development
...
| Recreation Information Database|https://ridb.recreation.gov/ | Recreational areas, federal lands, historic sites, museums, and other attractions/resourcesUS | `apiKey` | Yes | Unknown |
...
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
| Countly|https://api.count.ly/reference | Countly web analytics | No | No | Unknown |Open Source Project
| Creative Commons Catalog|https://api.creativecommons.engineering/ | Search among openly licensed and public domain works | `OAuth` | Yes | Yes |Open Source Project
| Datamuse|https://www.datamuse.com/api/ | Word-finding query engine | No | Yes | Unknown |Open Source Project
| Drupal.org|https://www.drupal.org/drupalorg/docs/api | Drupal.org | No | Yes | Unknown |Open Source Project
| Evil Insult Generator|https://evilinsult.com/api | Evil Insults | No | Yes | Yes |Open Source Project
| GitHub Contribution Chart Generator|https://github-contributions.vercel.app | Create an image of your GitHub contributions | No | Yes | Yes |Open Source Project
| GitHub ReadMe Stats|https://github.com/anuraghazra/github-readme-stats | Add dynamically generated statistics to your GitHub profile ReadMe | No | Yes | Yes |Open Source Project
| Metabase|https://www.metabase.com/ | An open source Business Intelligence server to share data and analytics inside your company | No | Yes | Yes |Open Source Project
| Shields|https://shields.io/ | Concise, consistent, and legible badges in SVG and raster format | No | Yes | Unknown |Open Source ProjectApplication and general security
...
| Udemyinstructor|https://www.udemy.com/developers/instructor/ | API for instructors on Udemy | `apiKey` | Yes | Unknown |
...
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
| Application Environment Verification|https://github.com/fingerprintjs/aev | Android library and API to verify the safety of user devices, detect rooted devices and other risks | `apiKey` | Yes | Yes |Application and general security
| BinaryEdge|https://docs.binaryedge.io/api-v2.html | Provide access to BinaryEdge 40fy scanning platform | `apiKey` | Yes | Yes |Application and general security
| BitWarden|https://bitwarden.com/help/api/ | Best open-source password manager | `OAuth` | Yes | Unknown |Application and general security
| Botd|https://github.com/fingerprintjs/botd | Botd is a browser library for JavaScript bot detection | `apiKey` | Yes | Yes |Application and general security
| Bugcrowd|https://docs.bugcrowd.com/api/getting-started/ | Bugcrowd API for interacting and tracking the reported issues programmatically | `apiKey` | Yes | Unknown |Application and general security
| Censys|https://search.censys.io/api | Search engine for Internet connected host and devices | `apiKey` | Yes | No |Application and general security
| Classify|https://classify-web.herokuapp.com/#/api | Encrypting & decrypting text messages | No | Yes | Yes |Application and general security
| Complete Criminal Checks|https://completecriminalchecks.com/Developers | Provides data of offenders from all U.S. States and Pureto Rico | `apiKey` | Yes | Yes |Application and general security
| CRXcavator|https://crxcavator.io/apidocs | Chrome extension risk scoring | `apiKey` | Yes | Unknown |Application and general security
| Dehash.lt|https://github.com/Dehash-lt/api | Hash decryption MD5, SHA1, SHA3, SHA256, SHA384, SHA512 | No | Yes | Unknown |Application and general security
| EmailRep|https://docs.emailrep.io/ | Email address threat and risk prediction | No | Yes | Unknown |Application and general security
| Escape|https://github.com/polarspetroll/EscapeAPI | An API for escaping different kind of queries | No | Yes | No |Application and general security
| FilterLists|https://filterlists.com | Lists of filters for adblockers and firewalls | No | Yes | Unknown |Application and general security
| FingerprintJS Pro|https://dev.fingerprintjs.com/docs | Fraud detection API offering highly accurate browser fingerprinting | `apiKey` | Yes | Yes |Application and general security
| FraudLabs Pro|https://www.fraudlabspro.com/developer/api/screen-order | Screen order information using AI to detect frauds | `apiKey` | Yes | Unknown |Application and general security
| FullHunt|https://api-docs.fullhunt.io/#introduction | Searchable attack surface database of the entire internet | `apiKey` | Yes | Unknown |Application and general security
| GitGuardian|https://api.gitguardian.com/doc | Scan files for secrets API Keys, database credentials | `apiKey` | Yes | No |Application and general security
| GreyNoise|https://docs.greynoise.io/reference/get_v3-community-ip | Query IPs in the GreyNoise dataset and retrieve a subset of the full IP context data | `apiKey` | Yes | Unknown |Application and general security
| HackerOne|https://api.hackerone.com/ | The industry’s first hacker API that helps increase productivity towards creative bug bounty hunting | `apiKey` | Yes | Unknown |Application and general security
| Hashable|https://hashable.space/pages/api/ | A REST API to access high level cryptographic functions and methods | No | Yes | Yes |Application and general security
| HaveIBeenPwned|https://haveibeenpwned.com/API/v3 | Passwords which have previously been exposed in data breaches | `apiKey` | Yes | Unknown |Application and general security
| Intelligence X|https://github.com/IntelligenceX/SDK/blob/master/Intelligence%20X%20API.pdf | Perform OSINT via Intelligence X | `apiKey` | Yes | Unknown |Application and general security
| LoginRadius|https://www.loginradius.com/docs/ | Managed User Authentication Service | `apiKey` | Yes | Yes |Application and general security
| Microsoft Security Response Center MSRC|https://msrc.microsoft.com/report/developer | Programmatic interfaces to engage with the Microsoft Security Response Center MSRC | No | Yes | Unknown |Application and general security
| Mozilla http scanner|https://github.com/mozilla/http-observatory/blob/master/httpobs/docs/api.md | Mozilla observatory http scanner | No | Yes | Unknown |Application and general security
| Mozilla tls scanner|https://github.com/mozilla/tls-observatory#api-endpoints | Mozilla observatory tls scanner | No | Yes | Unknown |Application and general security
| National Vulnerability Database|https://nvd.nist.gov/vuln/Data-Feeds/JSON-feed-changelog | U.S. National Vulnerability Database | No | Yes | Unknown |Application and general security
| Passwordinator|https://github.com/fawazsullia/password-generator/ | Generate random passwords of varying complexities | No | Yes | Yes |Application and general security
| PhishStats|https://phishstats.info/ | Phishing database | No | Yes | Unknown |Application and general security
| Privacy.com|https://privacy.com/developer/docs | Generate merchant-specific and one-time use credit card numbers that link back to your bank | `apiKey` | Yes | Unknown |Application and general security
| Pulsedive|https://pulsedive.com/api/ | Scan, search and collect threat intelligence data in real-time | `apiKey` | Yes | Unknown |Application and general security
| SecurityTrails|https://securitytrails.com/corp/apidocs | Domain and IP related information such as current and historical WHOIS and DNS records | `apiKey` | Yes | Unknown |Application and general security
| Shodan|https://developer.shodan.io/ | Search engine for Internet connected devices | `apiKey` | Yes | Unknown |Application and general security
| Spyse|https://spyse-dev.readme.io/reference/quick-start | Access data on all Internet assets and build powerful attack surface management applications | `apiKey` | Yes | Unknown |Application and general security
| Threat Jammer|https://threatjammer.com/docs/index | Risk scoring service from curated threat intelligence data | `apiKey` | Yes | Unknown |Application and general security
| UK Police|https://data.police.uk/docs/ | UK Police data | No | Yes | Unknown |Application and general security
| Virushee|https://api.virushee.com/ | Virushee file/data scanning | No | Yes | Yes |Application and general security
| VulDB|https://vuldb.com/?doc.api | VulDB API allows to initiate queries for one or more items along with transactional bots | `apiKey` | Yes | Unknown |Application and general security
